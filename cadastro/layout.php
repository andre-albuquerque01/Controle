            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../pesquisar/cliente.php">Cliente</a></li>
                            <li><a class="dropdown-item" href="../pesquisar/reparo.php">Reparo</a></li>
                            <li><a class="dropdown-item" href="../pesquisar/tecnico.php">Tecnico</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
