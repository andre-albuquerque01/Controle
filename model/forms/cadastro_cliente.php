...
<?php
if (isset($_POST['nome_completo']) && isset($_POST['email_cliente']) && isset($_POST['telefone_celular']) &&isset($_POST['cep'])) {
  $cep = $_POST['cep'] ?? "";
  $cidade = $_POST['cidade'] ?? "";
  $uf = $_POST['uf'] ?? "";
  $bairro = $_POST['bairro'] ?? "";
  ...
  $cruds->cliente($cep, $cidade, $uf, $bairro, $rua, $complemento, $nome_completo, $email_cliente, $telefone_celular, $telefone_contato);
}
?>
